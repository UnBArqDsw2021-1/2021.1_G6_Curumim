...
## 1. Épicos
&emsp;&emsp;<!-- Alguma explicação sobre épicos (embasada de preferência)-->
...
## 2. Features
&emsp;&emsp;<!-- Alguma explicação sobre features (embasada de preferência)-->
...
&emsp;&emsp;<!-- Alguma explicação sobre US (embasada de preferência) e com exemplo da forma de escrita-->
...
<!-- Mais alguma fonte que corroborem as explicações adicionadas -->
## Versionamento
